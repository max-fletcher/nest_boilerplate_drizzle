...
@Injectable()
export class JwtStrategy extends PassportStrategy(Strategy, 'jwt-strategy'){ // extending a strategy so we can add functionality to it
  ...
  async validate(payload: any){
    ...
    // validating user by seeing if a user with this id/email/email+name etc(as per logic inside this method) exists in database
